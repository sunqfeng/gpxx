    ...
    <div id="app">
        ...
        <el-row>
            <el-col :span="24"></el-col>
                <el-col :span="24"   :row-style="{height:'60px'}" :cell-style="{padding:'10px'}" >
                    <el-input placeholder="请输入股票id号" suffix-icon="el-icon-date" v-model="sear_gpxxid" style="width: 10%">
                    </el-input>
                    <el-input placeholder="请输入股票名称" suffix-icon="el-icon-date" v-model="sear_gpmc" style="width: 10%">
                    </el-input>

                    <el-button type="primary" icon="el-icon-search" @click="search(sear_gpxxid,sear_gpmc)">搜索</el-button>

                    <el-button type="primary" style="width: 8%" @click="addMasterUser()">新增</el-button>
                </el-col>
            ...
            <!-- <el-col :span="24">
              <el-button type="primary" style="width: 10%" @click="addMasterUser()" >新增</el-button>
          </el-col> -->
        </el-row>
